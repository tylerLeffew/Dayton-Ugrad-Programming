...
public class Main {
    ...
    public static void fancyPrint(Book book) {
        ...
        boolean hasPublisher = true;
        boolean hasPages = true;
        boolean hasPrice = true;
        boolean hasDate = true;
        GregorianCalendar releaseDate = new GregorianCalendar(200,0,1);
        ...
        if(hasTitle||hasISBN ||hasAuthor ||hasPublisher || hasPages || hasPrice ||hasDate)
        {
            if(hasTitle) {
            ...
            if(hasDate) {
            System.out.println("Date: " + formatCalendar(book.getReleaseDate()));
            }

            /**
             *  CSCE 145 Students: You need to create the other boolean expressions
             */
        } else {
    ...
    /**
     * Given a Gregorian caledar, convert the calendar to a String.
     * @param calendar A Gregorian calendar that has a year/month/date representation.
     * @return A string representation of the supplied Gregorian calendar.
     */
