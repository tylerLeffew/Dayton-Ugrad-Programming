...
--------
#### Lab objective:
The objective of the program is to get the user set up a deal with the user where they choose what type of house they want and 
...
--------
#### Lab objective:
 The objective of the program is to print all the ordinal numbers based on a user input from 1 to 1000.
...
--------
#### Lab objective:
 The objective of the program is to calucuate student grades using a grader class.
